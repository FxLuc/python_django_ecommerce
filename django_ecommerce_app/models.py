...
class CustomUser(AbstractUser):
    ...
    user_type = models.CharField(max_length=150, choices=user_type_choices, default=1)
...
class Products(models.Model):
    ...
    product_max_price = models.CharField(max_length=150)
    product_discount_price = models.CharField(max_length=150)
...
class ProductTransaction(models.Model):
    ...
    transaction_type = models.CharField(
        choices=transaction_type_choices, max_length=150)
    transaction_description = models.CharField(max_length=150)
    created_at = models.DateTimeField(auto_now_add=True)
...
class ProductDetails(models.Model):
    ...
    product_id = models.ForeignKey(Products, on_delete=models.CASCADE)
    title = models.CharField(max_length=150)
    title_details = models.CharField(max_length=150)
    created_at = models.DateTimeField(auto_now_add=True)
    is_active = models.IntegerField(default=1)
...
class ProductReviews(models.Model):
    ...
    rating = models.CharField(default="5", max_length=150)
...
class CustomerOrders(models.Model):
    ...
    purchase_price = models.CharField(max_length=150)
    coupon_code = models.CharField(max_length=150)
    discount_amt = models.CharField(max_length=150)
    product_status = models.CharField(max_length=150)
    created_at = models.DateTimeField(auto_now_add=True)
