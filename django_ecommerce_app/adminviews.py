...
from django_ecommerce_app.models import Categories,SubCategories,CustomUser,MerchantUser,Products,ProductAbout,ProductDetails,ProductMedia,ProductTransaction,ProductTags,StaffUser,CustomerUser
from django.core.files.storage import FileSystemStorage
from django.urls import reverse
from django.http import HttpResponseRedirect,HttpResponse
from django.db.models import Q
from django_ecommerce.settings import BASE_URL
...
class MerchantUserCreateView(SuccessMessageMixin,CreateView):
    ...
    def form_valid(self,form):
        ...
        user.merchantuser.phone_number=self.request.POST.get("phone_number")
...
class MerchantUserUpdateView(SuccessMessageMixin,UpdateView):
    ...
    def form_valid(self,form):
        ...
        merchantuser.phone_number=self.request.POST.get("phone_number")
        is_added_by_admin=False
        if self.request.POST.get("is_added_by_admin")=="on":
            is_added_by_admin=True
